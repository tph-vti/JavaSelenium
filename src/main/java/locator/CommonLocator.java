...
public class CommonLocator {
    ...
    public static final By EMAIL_INPUT = By.id("susbscribe_email");
    public static final By SUBSCRIBE_BUTTON = By.id("subscribe");
    public static final By SUCCESS_MESSAGE = By.cssSelector(".alert-success.alert");
    ...
    public static final By CONTINUE_BUTTON = By.cssSelector("[data-qa='continue-button']");
}
