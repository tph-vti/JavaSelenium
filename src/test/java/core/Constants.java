...
public final class Constants {
    public static final String LOGIN_TO_YOUR_ACCOUNT_TITLE = "Login to Your Account";
    public static final String NEW_USER_SIGNUP_TITLE = "New User Signup!";
    public static final String ENTER_ACCOUNT_INFORMATION_TITLE = "ENTER ACCOUNT INFORMATION";
    public static final String ACCOUNT_CREATED_TITLE = "ACCOUNT CREATED!";
    public static final String ACCOUNT_DELETED_TITLE = "ACCOUNT DELETED!";
